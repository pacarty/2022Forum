    ...
    public class ForumService : IForumService
    {
        ...
        private async Task SeedDb()
        {
            ...
            List<Subforum> subforumList = new List<Subforum>()
            {
                ...
                new Subforum() { Name = "Life" },
                new Subforum() { Name = "Entertainment" },
                new Subforum() { Name = "Lounges" }
            };
            ...
            List<Topic> topicList = new List<Topic>()
            {
                ...
                new Topic() { Name = "Windows", SubforumId = 1 },
                new Topic() { Name = "Apple", SubforumId = 1 },
                new Topic() { Name = "Linux/BSD", SubforumId = 1 },
                ...
                new Topic() { Name = "Web development", SubforumId = 2 },
                new Topic() { Name = "Programming", SubforumId = 2 },
                ...
                new Topic() { Name = "Optus Broadband", SubforumId = 3 },
                new Topic() { Name = "Aussie Broadband", SubforumId = 3 },
                new Topic() { Name = "TPG Group", SubforumId = 3 },
                new Topic() { Name = "Vocus Group", SubforumId = 3 },
                new Topic() { Name = "Superloop", SubforumId = 3 },
                new Topic() { Name = "Exetel", SubforumId = 3 },
                new Topic() { Name = "Other ISPs", SubforumId = 3 },
                ...
                new Topic() { Name = "Android tablets", SubforumId = 4 },
                new Topic() { Name = "Other phones", SubforumId = 4 },
                new Topic() { Name = "Jobs", SubforumId = 5 },
                new Topic() { Name = "Education", SubforumId = 5 },
                new Topic() { Name = "Finance", SubforumId = 5 },
                new Topic() { Name = "Real Estate", SubforumId = 5 },
                new Topic() { Name = "Lifestyle", SubforumId = 5 },
                new Topic() { Name = "Shopping", SubforumId = 5 },
                new Topic() { Name = "Travel", SubforumId = 5 },
                new Topic() { Name = "Home Theatre", SubforumId = 6 },
                new Topic() { Name = "TV shows", SubforumId = 6 },
                new Topic() { Name = "Movies", SubforumId = 6 },
                new Topic() { Name = "Music", SubforumId = 6 },
                new Topic() { Name = "Gaming", SubforumId = 6 },
                new Topic() { Name = "Sport", SubforumId = 6 },
                new Topic() { Name = "Automotive", SubforumId = 7 },
                new Topic() { Name = "Photography", SubforumId = 7 },
                new Topic() { Name = "Home", SubforumId = 7 },
                new Topic() { Name = "Energy", SubforumId = 7 },
                new Topic() { Name = "Hobbies/Interests", SubforumId = 7 },
                new Topic() { Name = "Gadgets", SubforumId = 7 },
                new Topic() { Name = "On the internet", SubforumId = 7 }
            };
            ...
            List<Post> postList = new List<Post>()
            {
                ...
                new Post() { Name = "FTTN to FTTP Upgrade via Telstra - Advice", TopicId = 17, UserId = users[1].Id },
                new Post() { Name = "Telstra support, MASSIVE IMPROVEMENT", TopicId = 17, UserId = users[5].Id },
                new Post() { Name = "Ultrafast Availability", TopicId = 17, UserId = users[4].Id },
                new Post() { Name = "Optus Fetch Return Request", TopicId = 18, UserId = users[5].Id },
                new Post() { Name = "Is my public IP address static ?", TopicId = 18, UserId = users[0].Id },
                new Post() { Name = "Can no longer connect to ATO via my Optus NBN", TopicId = 18, UserId = users[1].Id },
                new Post() { Name = "Two-Factor Authentication", TopicId = 19, UserId = users[0].Id },
                new Post() { Name = "Aussie Broadband - Dual Stack IPv6 on NBN", TopicId = 19, UserId = users[1].Id },
                new Post() { Name = "is it possible to change provider after FTTP", TopicId = 19, UserId = users[1].Id },
                new Post() { Name = "iiNet wants to introduce 2-factor authentication", TopicId = 20, UserId = users[3].Id },
                new Post() { Name = "10 second delay incoming NodePhone VOIP calls", TopicId = 20, UserId = users[5].Id },
                new Post() { Name = "IInet privacy breach.", TopicId = 20, UserId = users[2].Id },
                new Post() { Name = "Vocus Group Speed Test Results Thread ", TopicId = 21, UserId = users[2].Id },
                new Post() { Name = "Dodo to remove email servers", TopicId = 21, UserId = users[5].Id },
                new Post() { Name = "What support.", TopicId = 21, UserId = users[0].Id },
                new Post() { Name = "New customer experience discussions", TopicId = 22, UserId = users[1].Id },
                new Post() { Name = "NBN orders going missing in the system??", TopicId = 22, UserId = users[3].Id },
                new Post() { Name = "Price Increase?", TopicId = 22, UserId = users[4].Id },
                new Post() { Name = "Speed Boost button", TopicId = 23, UserId = users[4].Id },
                new Post() { Name = "Speed Boost button", TopicId = 23, UserId = users[3].Id },
                new Post() { Name = "Exetel sim mobile plans", TopicId = 23, UserId = users[5].Id },
                new Post() { Name = "Launtel - General Discussion", TopicId = 24, UserId = users[1].Id },
                new Post() { Name = "AU SIM card o/seas but no roaming plan. SMS fwd?", TopicId = 25, UserId = users[5].Id },
                new Post() { Name = "Telstra BYO Plans", TopicId = 25, UserId = users[1].Id },
                new Post() { Name = "Moved from Telstra to Optus... mistake?", TopicId = 25, UserId = users[3].Id },
                new Post() { Name = "Node 1 Internet - Perth/Geraldton", TopicId = 26, UserId = users[2].Id },
                new Post() { Name = "4G Mobile Broadband Advice", TopicId = 26, UserId = users[1].Id },
                new Post() { Name = "500GB/mo public static IP on mobile broadband ?", TopicId = 26, UserId = users[0].Id },
                new Post() { Name = "iPhone 13/Mini/Pro/Max - General Discussion", TopicId = 27, UserId = users[0].Id },
                new Post() { Name = "iPhone 13 pro battery failing fast", TopicId = 27, UserId = users[3].Id },
                new Post() { Name = "iPhone se 2020 problems", TopicId = 27, UserId = users[3].Id },
                new Post() { Name = "OPPO Find X3 5G Pro, Neo & Lite", TopicId = 28, UserId = users[2].Id },
                new Post() { Name = "Google Pixel 6 / 6 Pro (2021)", TopicId = 28, UserId = users[4].Id },
                new Post() { Name = "Nothing Phone 1", TopicId = 28, UserId = users[1].Id },
                new Post() { Name = "Cheap Tablet For The Kids", TopicId = 29, UserId = users[0].Id },
                new Post() { Name = "Samsung Galaxy Tab A8 10.5\" (2022)", TopicId = 29, UserId = users[1].Id },
                new Post() { Name = "Samsung Galaxy Tab S8 and S8+", TopicId = 29, UserId = users[5].Id },
                new Post() { Name = "Phone for elderly", TopicId = 30, UserId = users[4].Id },
                new Post() { Name = "Smart dumb phone, dumb smart phone?", TopicId = 30, UserId = users[5].Id },
                new Post() { Name = "HTC Tytn / Dopod 838 Pro", TopicId = 30, UserId = users[5].Id },
                new Post() { Name = "JobSeeker", TopicId = 31, UserId = users[1].Id },
                new Post() { Name = "Worst Interview Stories", TopicId = 31, UserId = users[0].Id },
                new Post() { Name = "The Teachers' Thread", TopicId = 31, UserId = users[0].Id },
                new Post() { Name = "Finished uni and unsure how to feel", TopicId = 32, UserId = users[1].Id },
                new Post() { Name = "CSU puts my home address on digital transcript", TopicId = 32, UserId = users[4].Id },
                new Post() { Name = "considering switching universities - law", TopicId = 32, UserId = users[4].Id },
                new Post() { Name = "Buying a house through SMSF", TopicId = 33, UserId = users[3].Id },
                new Post() { Name = "What exactly is a trust?", TopicId = 33, UserId = users[5].Id },
                new Post() { Name = "Vanguard Annual Tax Statement", TopicId = 33, UserId = users[2].Id },
                new Post() { Name = "VIC property market and price discussion", TopicId = 34, UserId = users[5].Id },
                new Post() { Name = "QLD property market and price discussion", TopicId = 34, UserId = users[3].Id },
                new Post() { Name = "Should I buy my first home now or keep waiting", TopicId = 34, UserId = users[5].Id },
                new Post() { Name = "AliExpress delivered from China", TopicId = 36, UserId = users[4].Id },
                new Post() { Name = "where to park in Sydney CBD for shopping", TopicId = 36, UserId = users[3].Id },
                new Post() { Name = "How to sell on Ebay Canada?", TopicId = 36, UserId = users[0].Id },
                new Post() { Name = "Australia Post General Discussion", TopicId = 36, UserId = users[1].Id },
                new Post() { Name = "qantas international to domestic sydney", TopicId = 37, UserId = users[1].Id },
                new Post() { Name = "Delays at domestic terminals", TopicId = 37, UserId = users[2].Id },
                new Post() { Name = "TCL 2021 TVs ", TopicId = 38, UserId = users[1].Id },
                new Post() { Name = "Ch 10: Hunted 2022", TopicId = 39, UserId = users[3].Id },
                new Post() { Name = "The Orville (Spoilers)", TopicId = 39, UserId = users[5].Id },
                new Post() { Name = "Westworld (Spoilers)", TopicId = 39, UserId = users[0].Id },
                new Post() { Name = "What Was the Name of That Movie?", TopicId = 40, UserId = users[0].Id },
                new Post() { Name = "Batgirl (201x)", TopicId = 40, UserId = users[3].Id },
                new Post() { Name = "Thirteen Lives (2022) Prime", TopicId = 40, UserId = users[3].Id },
                new Post() { Name = "Lightyear (2022)", TopicId = 40, UserId = users[4].Id },
                new Post() { Name = "Music I'm Listening to Now", TopicId = 41, UserId = users[2].Id },
                new Post() { Name = "Bedroom DJ's... any out there?", TopicId = 41, UserId = users[1].Id },
                new Post() { Name = "Dance-driven music videos", TopicId = 41, UserId = users[1].Id },
                new Post() { Name = "Steam Deck", TopicId = 42, UserId = users[5].Id },
                new Post() { Name = "World of Warcraft: Classic", TopicId = 42, UserId = users[4].Id },
                new Post() { Name = "Genshin Impact", TopicId = 42, UserId = users[5].Id },
                new Post() { Name = "AFL 2022 Premiership Season", TopicId = 43, UserId = users[0].Id },
                new Post() { Name = "English Premier League 2022/23", TopicId = 43, UserId = users[4].Id },
                new Post() { Name = "MotoGP 2022 Season", TopicId = 43, UserId = users[2].Id },
                new Post() { Name = "Subaru XV ", TopicId = 44, UserId = users[5].Id },
                new Post() { Name = "RS3 and RSQ3 6+ month wait times...", TopicId = 44, UserId = users[3].Id },
                new Post() { Name = "BYD Atto 3 (Yuan Plus)", TopicId = 44, UserId = users[1].Id },
                new Post() { Name = "CASA photo competition and licencing", TopicId = 45, UserId = users[1].Id },
                new Post() { Name = "Will we need cameras in 10 years?", TopicId = 45, UserId = users[3].Id },
                new Post() { Name = "Toward that often dreamt of \"universal\" mount ?", TopicId = 45, UserId = users[0].Id },
                new Post() { Name = "New Bathroom Exhaust Fan Advice", TopicId = 46, UserId = users[3].Id },
                new Post() { Name = "Which fridge brand...?", TopicId = 46, UserId = users[0].Id },
                new Post() { Name = "High electricity usage when no one was at home", TopicId = 47, UserId = users[1].Id },
                new Post() { Name = "Melbourne solar - confirmation", TopicId = 47, UserId = users[5].Id },
                new Post() { Name = "Tesla Energy Plan (VPP) - any good?", TopicId = 47, UserId = users[0].Id },
                new Post() { Name = "Old Valve/Tube Radios", TopicId = 48, UserId = users[0].Id },
                new Post() { Name = "Tabletop Gaming Thread", TopicId = 48, UserId = users[4].Id },
                new Post() { Name = "The Lego Thread", TopicId = 48, UserId = users[2].Id },
                new Post() { Name = "Xiaomi Air Purifier - Which one to get?", TopicId = 49, UserId = users[1].Id },
                new Post() { Name = "Replacement of flickering LED Floodlights globes", TopicId = 49, UserId = users[1].Id },
                new Post() { Name = "Garmin Fenix 6", TopicId = 49, UserId = users[2].Id },
                new Post() { Name = "Gmail alternatives", TopicId = 50, UserId = users[3].Id }
            };
